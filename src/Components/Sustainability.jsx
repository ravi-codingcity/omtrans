  ...
  return (
    <div>
      ...
      <div className=" py-5 max-w-screen-lg m-auto sm:px-0 px-3">
        <h1 className="text-4xl font-bold py-2 text-center text-red-600">
      ...
      <div className="sm:mx-0 mx-4">
        <div className="flex flex-wrap justify-center  max-w-screen-lg items-center m-auto my-5  ">
          {[
            ...
            <div
              key={index}
              className="bg-blue-100 mx-2 my-2 w-72 min-h-72 py-8 px-6 text-center flex flex-col justify-between rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
            >
      ...
      <div className="flex py-20 bg-slate-100 justify-evenly items-center mt-10">
        <div>
          <p className="text-2xl sm:py-5 py-2 max-w-screen-lg text-center m-auto font-semibold sm:mx-0 mx-2">
