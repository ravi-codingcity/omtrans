...
const router = createBrowserRouter([
  ...
  { path: "/lcl_sea_export/thank_you", element: <Thank_you /> },
  { path: "/lcl_sea_import/thank_you", element: <Thank_you /> },
  { path: "/fcl_sea_export/thank_you", element: <Thank_you /> },
  { path: "/fcl_sea_import/thank_you", element: <Thank_you /> },
  { path: "/air_import/thank_you", element: <Thank_you /> },
  { path: "/air_export/thank_you", element: <Thank_you /> },
  { path: "/lcl_sea_export", element: <LCL_sea_export /> },
  { path: "/lcl_sea_export/step2", element: <LCL_sea_export_step2 /> },
  { path: "/lcl_sea_import/step2", element: <LCL_sea_import_step2 /> },
  { path: "/fcl_sea_export/step2", element: <FCL_sea_export_step2 /> },
  { path: "/fcl_sea_import/step2", element: <FCL_sea_import_step2 /> },
]);
