...
function FCL_sea_export() {
  const navigate = useNavigate();
  const form = useRef();
  const [hsCode, setHsCode] = useState("");
  const [Fix_shipment, setShipment] = useState("FCL Sea Export");
  ...
  const handleContainerType = (e) => {
    setContainer_type(e.target.value);
    setForm1Data((prevData) => ({
      ...prevData,
      type_of_container: e.target.value, // Update shipment in form1Data
    }));
  };
    ...
    <div>
      ...
      <div className="flex flex-col items-center bg-slate-200">
        <div className="max-w-screen-lg m-auto py-3">
          <h1 className="text-4xl py-3 font-bold">FCL - Sea Export</h1>
          <p className="py-1">
        ...
        <form ref={form} onSubmit={handleSubmit}>
          <div className="max-w-screen-lg m-auto px-4 text-base">
            ...
            <div className="pt-2 pb-6">
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1 grid-rows-1">
                <div className="my-3 hidden grid-cols-4 grid-rows-1 items-center bg-white py-1 px-5">
                  ...
                  >
                    <option value="LCL Sea Export" selected>
                      FCL - Sea Export
                    </option>
                  </select>
                </div>
            ...
            <div className="pt-2 pb-6">
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1grid-rows-1">
                {/* Container Type */}
                <div className="my-2 flex items-center bg-white px-5 mx-1 py-1 border border-blue-600">
                  <label
                  ...
                  >
                    ...
                    <option value="20' Collapsible Flat Rack">
                      20' Collapsible Flat Rack
                    </option>
                    <option value="40' Collapsible Flat Rack">
                ...
                <div className="my-2 flex items-center bg-white px-5 mx-1 py-1 border border-blue-600">
                  ...
                  >
                    <option value="" disabled selected>
                      Select your Stuffing Mode
                    </option>
                    <option value="Factory">Factory</option>
                    <option value="Port/ICD">Port/ICD</option>
                  </select>
                </div>
              </div>
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 grid-rows-1">
              ...
              <div className="my-2 flex items-center bg-white px-5 mx-1 py-3 border border-blue-600">
                <input
                  type="checkbox"
                  id="haze_cargo"
                  name="haze_cargo"
