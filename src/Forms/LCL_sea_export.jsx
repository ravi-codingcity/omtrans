    ...
    <div>
      ...
      <div className="flex flex-col items-center bg-slate-200">
        <div className="max-w-screen-lg m-auto py-3 px-3">
          <h1 className="text-4xl py-3 font-bold ">LCL - Sea Export</h1>
          <p className="py-1">
          ...
          <div className="max-w-screen-lg m-auto sm:px-4 px-2 text-base">
              ...
              <div className="grid sm:grid-cols-2 grid-cols-1  grid-rows-1 items-center">
                ...
                <div className="my-2 flex items-center bg-white px-5 mx-1 py-1 border border-blue-600">
                  ...
                  <select
                    name="hs_code"
                    id="hs_code"
                    className="bg-white focus:ring-white focus:outline-none focus:ring-0 text-gray-900 text-sm rounded-lg p-2.5 flex-grow ml-3 py-3"
                    value={hsCode}
            ...
            <div className="grid sm:grid-cols-2 grid-cols-1 grid-rows-1">
              ...
              <div className="my-2 flex items-center bg-white px-5 mx-1 py-3 border border-blue-600">
                ...
                >
                  Hazardous Cargo <span className="ml-2 animate-pulse">🔥</span>
                </label>
              </div>
