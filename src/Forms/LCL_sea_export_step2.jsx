...
function LCL_sea_export_step2() {
  ...
  const sendEmail = async (e) => {
    ...
    // Retrieve data from form1 (previous page)
    ...
    emailjs
      .send(
        "service_8kjg68f", // EmailJS Service ID service_inkbhof
        "template_pigu21j", // EmailJS Template ID
        combinedData, // Send combined form data
      ...
      .then(
        () => {
          ...
          navigate("/lcl_sea_export/thank_you");
          window.scrollTo(0, 0);
        },
        (error) => {
          setPending(false);
...
export default LCL_sea_export_step2;
