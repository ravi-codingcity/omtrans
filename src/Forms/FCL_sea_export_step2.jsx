                ...
                <div className="grid sm:grid-cols-2 grid-cols-1 grid-rows-1 items-center">
                  ...
                  <div className="my-2 flex items-center bg-white px-5 mx-1 py-1 border border-blue-600">
                    ...
                    <select
                      ...
                      className="bg-white focus:ring-white focus:outline-none focus:ring-0 text-gray-900 text-sm rounded-lg p-2.5 flex-grow "
                      required
                    >
...
export default FCL_sea_import_step2;
