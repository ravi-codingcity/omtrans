...
function Air_export_step2() {
  ...
  const [form2Data, setForm2Data] = useState({
    ...
    user_state: "",
    user_number: "",
    reference_number: "", // Reference number will be set after fetching
  });
  ...
  const sendEmail = async (e) => {
    ...
    emailjs
      .send("service_8kjg68f", "template_93rg6vf", combinedData, {
...
export default Air_export_step2;
