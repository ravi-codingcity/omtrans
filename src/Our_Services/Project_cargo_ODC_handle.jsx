...
import maruti_suzuki from "../assets/maruti_suzuki.jpg";
import suzuki from "../assets/suzuki.jpg";
import jindal_saw from "../assets/jindal_saw.jpg";
import jindal_plyesters from "../assets/jindal_plyesters.jpg";
import ambica from "../assets/ambica.jpg";
import ntn from "../assets/ntn.jpg";
        ...
        <div className=" max-w-screen-lg m-auto   sm:py-14 py-10">
          ...
          <div className="flex items-center justify-evenly flex-col sm:flex-row py-3 flex-wrap">
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={suzuki} alt="" className="w-20" />
              <div className="pt-2">
            ...
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={maruti_suzuki} alt="" className="w-20" />
              <div className="pt-2">
                <h3 className="text-xl pb-2 font-semibold">
            ...
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={jindal_saw} alt="" className="w-20" />
              <div className="pt-2">
                <h3 className="text-xl pb-2 font-semibold">Jindal Saw Ltd.</h3>
              </div>
            </div>
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={ntn} alt="" className="w-20" />
              <div className="pt-2">
            ...
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={jindal_plyesters} alt="" className="w-20" />
              <div className="pt-2">
                <h3 className="text-xl pb-2 font-semibold">
                  Jindal Polyesters
                </h3>
            ...
            <div className="py-4  px-6 w-[310px] h-[150px] border-2 border-blue-700 mt-2 mx-2">
              <img src={ambica} alt="" className="w-20" />
              <div className="pt-2">
                <h3 className="text-xl pb-2 font-semibold">
